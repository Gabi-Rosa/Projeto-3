    ...
    return(
        <div>
            ...
            <div className='container'>
                ...
                <p className='description2'>Na aba <Link className='link' to='#'>Nossos Livros </Link>você consegue ver quais livros estão disponivéis para serem emprestados.<br/> Já na aba <Link className='link'to='#'>Empreste um livro</Link> você deisponibiliza um livro que deseja emprestar. <br/><span>Pronto</span> agora deixe conosco que iremos conectar você a outro usuário, sem burocracia e sem dor de cabeça.<br/> <span>Rapído, simples e fácil</span>.</p>
